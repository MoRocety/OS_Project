...
joblib.dump(knn_reg, 'models/knn_regression_model_informed.joblib')
...
joblib.dump(tree_reg, 'models/decision_tree_regression_model_informed.joblib')
...
joblib.dump(random_forest_reg, 'models/random_forest_regression_model_informed.joblib')
